...
/**
 * Migration : ajout des rôles "Pilote" (pilote de chantier) et
 * "SousTraitant" à l'ENUM role.
...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.sequelize.query(
      "ALTER TYPE \"enum_utilisateur_role\" ADD VALUE IF NOT EXISTS 'Pilote';"
    );
    await queryInterface.sequelize.query(
      "ALTER TYPE \"enum_utilisateur_role\" ADD VALUE IF NOT EXISTS 'SousTraitant';"
    );
  },
