          ...
          <table role="presentation" width="100%" style="max-width:520px;background:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 2px 12px rgba(0,0,0,0.08);">
            ...
            <tr>
              <td style="padding:32px;">
                <h2 style="margin:0 0 12px;color:#1f2937;font-size:18px;">Bonjour ${nom},</h2>
                <p style="margin:0 0 20px;color:#4b5563;font-size:15px;line-height:1.6;">
                  Vous avez demandé la réinitialisation de votre mot de passe.
                  Utilisez le code ci-dessous :
                </p>
                <p style="margin:0 0 20px;text-align:center;">
                  <span style="display:inline-block;padding:14px 32px;background:#eef2ff;color:#1d4ed8;font-size:26px;font-weight:bold;letter-spacing:6px;border-radius:8px;">${otp}</span>
                </p>
                <p style="margin:0 0 8px;color:#6b7280;font-size:13px;line-height:1.6;">
                  Ce code expire dans <strong>1 heure</strong>. Si vous n'êtes pas à l'origine de cette demande,
